---
title: "Settings Sync"
source: "https://code.visualstudio.com/docs/configure/settings-sync#_troubleshooting-keychain-issues"
author:
  - "[[Microsoft]]"
published: 2021-11-03
created: 2026-04-25
description: "Synchronize your user settings across all your Visual Studio Code instances."
tags:
  - "clippings"
---
...
> **Note**: VS Code does not synchronize your extensions to or from a [remote](https://code.visualstudio.com/docs/remote/remote-overview) window, such as when you're connected to SSH, a development container (devcontainer), or WSL.
...
![Screenshot of the Manage menu, highlighting the Backup and Sync Settings command.](https://code.visualstudio.com/assets/docs/configure/settings-sync/turn-on-sync.png)
...
![Screenshot of the Settings Sync configure Quick Pick to select the settings to synchronize.](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-configure.png)
...
![Screenshot of the Settings Sync Quick Pick to choose an account type.](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-accounts.png)
...
![Settings Sync Merge or Replace dialog](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-merge-replace.png)
...
![Settings Sync Merges](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-merges-view.png)

Settings Sync Merges

## Configuring synced data

Machine settings (with `machine` or `machine-overridable` [scopes](https://code.visualstudio.com/updates/v1_34#_machinespecific-settings)) are not synchronized by default, since their values are specific to a given machine. You can also add or remove settings you want to this list from the Settings editor or using the setting.

![Settings Sync ignored settings](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-ignored-settings.png)

Keyboard Shortcuts are synchronized per platform by default. If your keyboard shortcuts are platform-agnostic, you can synchronize them across platforms by disabling the setting.

All built-in and installed extensions are synchronized along with their global enablement state. You can skip synchronizing an extension, either from the Extensions view (Ctrl+Shift+X) or using the setting.

![Settings Sync ignored settings](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-ignored-extensions.png)
...
![Settings Sync Switch Service](https://code.visualstudio.com/assets/docs/configure/settings-sync/settings-sync-switch.png)
...
![Settings Sync backup views](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-backup-views.png)
...
![Settings Sync enable local backup views](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-enable-local-activity-view.png)
...
![Settings Sync machines views](https://code.visualstudio.com/assets/docs/configure/settings-sync/sync-machines-view.png)
...
- [User and Workspace settings](https://code.visualstudio.com/docs/configure/settings) - Learn how to configure VS Code to your preferences through user and workspace settings.
...
- *(not recommended)* `basic`: See the [section below on basic text](#_not-recommended-configure-basic-text-encryption) for more details.
...
Yes. Please refer to the [Syncing Stable versus Insiders](#_syncing-stable-versus-insiders) section for more information.
